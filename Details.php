...
<head>
  ...
  <style>
    ...
    th {
      background: linear-gradient(#e75c62, #5f42fc);
      color: white;
    }
...
<body>
  ...
  <table>
    ...
    $username = "root";
    $password = "";
    $conn = mysqli_connect($server, $username, $password, "shruti");
    if (!$conn) {
    ...
    <div class="card container">
      ...
      if ($_GET['message'] == 'success') {
        echo "<h3><p style='color:blue;' class='messagehide'>Transaction was completed successfully</p></h3>";
      }
      ...
      <form action="transfer.php" method="POST">
        ...
        <select name="reciever" id="dropdown" class="textbox" required>
          ...
          <?php
          $db = mysqli_connect("localhost", "root", "", "shruti");
    ...
    <div id="hojaplz">
      <img src="images/mens.jpg" id="menuBtn">
    </div>
